    ...
    levels: [
      {
        level: 1,
        points: P(1),
        summary: 'Tangência ao tema OU Texto composto por aglomerado caótico de palavras OU Traços constantes de outros tipos textuais',
        rationale: {
          op: 'OR',
          multiple: true,
          items: [
      ...
      },
      {
        level: 2,
        points: P(2),
        summary: 'Abordagem completa do tema E 3 partes do texto (2 delas embrionárias) OU conclusão finalizada por frase incompleta //Redação com muitas cópias',
        rationale: {
          op: 'OR',
          items: [
            {
      ...
      },
      {
        level: 3,
        points: P(3),
        summary: 'Abordagem completa do tema E 3 partes do texto (1 delas embrionárias) E repertório baseado nos textos motivadores E/OU repertório não legitimado E/OU repertório legitimado MAS não pertecente ao tema',
        rationale: {
          op: 'AND',
          items: [
            { id: 'c2_l3_3partes_1_embrionaria', label: '3 partes do texto (1 delas embrionárias)' },
            {
              ...
              items: [
                ...
                { id: 'c2_l3_repertorio_legitimado_nao_pertinente', label: 'Repertório legitimado MAS não pertecente ao tema' },
              ],
            },
          ],
        },
      },
      {
        level: 4,
        points: P(4),
        summary: 'Abordagem completa do tema E 3 partes do texto (nenhuma embrionária) E repertório legitimado E pertinente ao tema, SEM uso produtivo.',
        rationale: {
          op: 'AND',
          items: [
      ...
      },
      {
        level: 5,
        points: P(5),
        summary: 'Abordagem completa do tema E 3 partes do texto (nenhuma embrionária) E repertório legitimado E pertinente ao tema, COM uso produtivo.',
        rationale: {
          op: 'AND',
          items: [
  ...
  },
  {
    ...
    levels: [
      ...
      { level: 1, points: P(1), summary: 'Projeto de texto sem foco temático ou distorcido' },
      {
        level: 2,
        points: P(2),
        summary: 'projeto de texto com MUITAS falhas E sem desenvolvimento ou desenvolvimento de apenas uma informação // Contradição grave',
        rationale: {
          op: 'OR',
          items: [
            {
      ...
      { level: 3, points: P(3), summary: 'projeto de texto com ALGUMAS falhas E Desenvolvimento de informações, fatos e opiniões com ALGUMAS lacunas' },
      { level: 4, points: P(4), summary: 'projeto de texto com POUCAS falhas E Desenvolvimento de informações, fatos e opiniões com POUCAS lacunas' },
      { level: 5, points: P(5), summary: 'Projeto de texto estratégico E Desenvolvimento de informações, fatos e opiniões em TODO o texto.' },
    ],
  },
  {
    key: 'C4',
...
const REASON_LABEL_MAP = (() => {
  ...
  ENEM_RUBRIC.forEach((competency) => {
    competency.levels.forEach((level) => traverse(level.rationale));
  });
  return map;
})();
...
module.exports = {
  ENEM_RUBRIC,
  ENEM_REASON_LABELS: REASON_LABEL_MAP,
};
