...
export function AnnotationSidebar({
  ...
  return (
    <aside
      className={`card RightRailCard comments-rail gw-rail-raise md:sticky md:top-20 flex h-full w-full min-w-0 max-w-none flex-col p-3 md:p-4 m-0 md:pl-0 ${className ?? ''}`}
    >
