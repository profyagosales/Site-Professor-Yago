...
export default function ThemesManager({ open, onClose }: Props) {
  ...
  async function toggleActive(t: any) {
    try {
      ...
      setErr(e?.response?.data?.message || 'Erro ao atualizar tema');
    }
  }
  ...
  async function createTheme() {
    ...
    try {
      ...
      setErr(e?.response?.data?.message || 'Erro ao criar tema');
    } finally {
      setCreating(false);
    }
  }
          ...
          <div className='md:col-span-2'>
            ...
            <div className='flex gap-2'>
              <input
                ...
                className='flex-1 rounded-lg border border-[#E5E7EB] p-2 focus:outline-none focus:ring-2 focus:ring-orange-500'
              />
              <button
