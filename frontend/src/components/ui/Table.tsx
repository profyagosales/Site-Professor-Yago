...
export const Th = ({ children }: { children: ReactNode }) => (
  <th className='text-left font-semibold text-ys-ink bg-ys-bg px-4 py-3 border-b border-ys-line'>
    {children}
  </th>
);

export const Td = ({ children }: { children: ReactNode }) => (
  <td className='text-ys-ink-2 px-4 py-3 border-b border-ys-line'>
    {children}
  </td>
);
