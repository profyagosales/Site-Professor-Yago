...
describe('virtualPages utils', () => {
  test('computeVisibleRange basic', () => {
    const r = computeVisibleRange({ numPages: 10, pageHeight: 1000, pageGap: 20, scrollTop: 0, viewportH: 600 });
  ...
  test('computeVisibleRange mid scroll', () => {
    ...
    const r = computeVisibleRange({ numPages: 10, pageHeight: 1000, pageGap: 20, scrollTop, viewportH: 600 });
