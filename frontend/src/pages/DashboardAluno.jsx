    ...
    <div className="pt-20 p-md">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-md">
        <div className="flex items-center p-md rounded-lg bg-gray-50/30 backdrop-blur-md border border-gray-200 shadow-subtle">
          ...
          >
            <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 20h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v11a2 2 0 002 2z" />
          </svg>
          <div>
        ...
        <div className="flex items-center p-md rounded-lg bg-gray-50/30 backdrop-blur-md border border-gray-200 shadow-subtle">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <path strokeLinecap="round" strokeLinejoin="round" d="M3 12l2 2 4-4m0 6l2 2 4-4m0 6l2 2 4-4" />
          </svg>
