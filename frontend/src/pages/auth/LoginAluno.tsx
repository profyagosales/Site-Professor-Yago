        ...
        <div className="grid md:grid-cols-2">
          ...
          <div className="relative hidden md:block rounded-2xl md:rounded-r-none md:rounded-l-2xl overflow-hidden">
            ...
            <div className="relative h-full p-8 flex flex-col justify-center">
              ...
              <h1 className="text-2xl font-extrabold text-ys-ink">Portal do Aluno</h1>
              <p className="text-ys-ink-2 mt-1">Notas • Redação • Recados • Gabaritos</p>
              <ul className="mt-6 space-y-2 text-sm text-ys-ink-2">
                <li className="flex items-start"><span className="text-ys-amber mr-2">•</span> Veja suas notas e recados</li>
                <li className="flex items-start"><span className="text-ys-amber mr-2">•</span> Envie redações e acompanhe correções</li>
                <li className="flex items-start"><span className="text-ys-amber mr-2">•</span> Acesse gabaritos e materiais</li>
              </ul>
            </div>
          </div>
          ...
          <CardBody className="p-6 sm:p-8">
            <div className="mb-6">
              <p className="tracking-[0.25em] text-xs text-ys-ink-3 mb-2">ALUNO</p>
              <h2 className="text-2xl font-extrabold text-ys-ink">Entrar no portal</h2>
              <p className="text-ys-ink-2 mt-1 text-sm">Use seu e-mail e sua senha.</p>
            </div>
