 ...
 */
export function isActive(pathname: string, route: string, exact: boolean = false): boolean {
  if (exact) {
 ...
 */
export function getNavItemClasses(isActive: boolean, primary: boolean = false): string {
